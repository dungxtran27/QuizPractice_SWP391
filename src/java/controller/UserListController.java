...
public class UserListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalSearch = new userDAO().getTotalAccount();
            ...
            ArrayList<User> listUserByPagging = ud.getListUsersByPagging(page, PAGE_SIZE);
            request.getSession().setAttribute("listUser", listUserByPagging);
          ...
          //  request.getSession().setAttribute("search_url", "search_user");
            request.setAttribute("pagination_url", "user-list?");
