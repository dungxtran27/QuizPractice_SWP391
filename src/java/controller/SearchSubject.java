...
//        } 
        ...
        totalSearch = new subjectListDAO().getTotalSubject(keyword);
        List<subject> listSubjectsByKeywordAndPagging = new subjectListDAO().getListSubjectsByKeywordAndPagging(keyword, page, PAGE_SIZE_3);
        ...
        request.setAttribute("pagination_url", "SearchSubject?keyword=" + keyword + "&");
